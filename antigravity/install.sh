...
# ~/.gemini/config/agents/<role>/, Antigravity's global-scoped custom
...
AGENT_NAMES=(tech-lead senior-dev implementer boilerplate code-reviewer debugger)
...
if [ "$UNINSTALL" = "1" ]; then
  ...
  # Remove the six <role> agent.md symlinks too — same warn-and-skip
...
# 5. Symlink each generated <role> agent directory into
...
log "the six agents actually appear in the Antigravity app's /agents"
