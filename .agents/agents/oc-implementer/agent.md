...
model: inherit
---
<!-- GENERATED from agents/implementer.md by scripts/sync-antigravity-agents.mjs — do not hand-edit -->
<!-- model: inherit is a repo-assigned Antigravity tier (ANTIGRAVITY_MODEL_BY_AGENT in sync-antigravity-agents.mjs) — not from the OpenCode source, which is model-free by design. -->
